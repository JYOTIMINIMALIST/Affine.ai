<?php get_header(); /*Template Name: Industry CPG Services */ ?>

<section class="industryServicesBanner industryServicesCPGBanner">
...
<section class="serviceSolutionsSection" id="indutryServicesPage">
    <?php if (have_rows('solution_and_strategy')) : ?>
        <?php while (have_rows('solution_and_strategy')) : the_row(); ?>
            ...
            if (!empty($iconone)) : ?>
                <img src="<?php echo esc_url($iconone['url']); ?>" loading="lazy" alt="<?php echo esc_attr($iconone['alt']); ?>" class="serviceCPGIcon" />
            <?php endif; ?>
            <?php $icontwo = get_sub_field('icon_two');
            if (!empty($icontwo)) : ?>
                <img src="<?php echo esc_url($icontwo['url']); ?>" loading="lazy" alt="<?php echo esc_attr($icontwo['alt']); ?>" class="serviceCPGIcon2" />
            <?php endif; ?>
            <div class="wrapper">
        ...
        <?php if (have_rows('explore_center')) : ?>
            <?php while (have_rows('explore_center')) : the_row(); ?>
                ...
                if (!empty($exploreiconimage)) : ?>
                    <img src="<?php echo esc_url($exploreiconimage['url']); ?>" loading="lazy" alt="<?php echo esc_attr($exploreiconimage['alt']); ?>" class="serviceCPGIcon3" />
                <?php endif; ?>
