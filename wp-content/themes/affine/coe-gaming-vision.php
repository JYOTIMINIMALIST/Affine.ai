<?php get_header(); /*Template Name: COE Gaming Vision */ ?>

<section class="coeAIVisionBanner coeGamingVisionBanner">
...
<img src="<?php bloginfo('template_directory'); ?>/images/gaming-vision-bg-1.png" alt="" class="visionGamingBg-1">
<img src="<?php bloginfo('template_directory'); ?>/images/gaming-vision-bg-2.png" alt="" class="visionGamingBg-2">
<img src="<?php bloginfo('template_directory'); ?>/images/gaming-vision-bg-3.png" alt="" class="visionGamingBg-3">
<img src="<?php bloginfo('template_directory'); ?>/images/gaming-vision-bg-3.png" alt="" class="visionGamingBg-4">
<img src="<?php bloginfo('template_directory'); ?>/images/gaming-vision-bg-2.png" alt="" class="visionGamingBg-5">
...
<section class="lifeSection expertsSection">
    <?php if (have_rows('experts_section', 527)) : ?>
        <?php while (have_rows('experts_section', 527)) : the_row(); ?>
