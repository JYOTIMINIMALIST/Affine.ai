<?php get_header(); /*Template Name: Industry Hitech Services */ ?>

<section class="industryServicesBanner industryServicesHitechBanner">
    ...
    <?php if (have_rows('solution_and_strategy')) : ?>
        <?php while (have_rows('solution_and_strategy')) : the_row(); ?>
            <div class="floaterAnimation floaterPhoneAnimation">
                ...
                if (!empty($icontwo)) : ?>
                    <img src="<?php echo esc_url($icontwo['url']); ?>" loading="lazy" alt="<?php echo esc_attr($icontwo['alt']); ?>" />
                <?php endif; ?>
