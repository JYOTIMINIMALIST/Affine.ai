<?php get_header(); /*Template Name: Industry CPG Solution */ ?>

<section class="industryServicesBanner industryServicesCPGBanner industrySolutionBanner">
    ...
    <a href="#indutrySolutionPage" class="scrollDown">
...
<section class="keySection" id="indutrySolutionPage">
    <?php if (have_rows('key_points_section')) : ?>
        <?php while (have_rows('key_points_section')) : the_row(); ?>
            <?php $iconone = get_sub_field('icon_one');
            if (!empty($iconone)) : ?>
                <img src="<?php echo esc_url($iconone['url']); ?>" loading="lazy" alt="<?php echo esc_attr($iconone['alt']); ?>" class="solutionCPGIcon" />
            <?php endif; ?>
            <?php $icontwo = get_sub_field('icon_two');
            if (!empty($icontwo)) : ?>
                <img src="<?php echo esc_url($icontwo['url']); ?>" loading="lazy" alt="<?php echo esc_attr($icontwo['alt']); ?>" class="solutionCPGIcon2" />
            <?php endif; ?>
            <div class="wrapper">
