<?php get_header(); /*Template Name: Industry Hitech Solution */ ?>

<section class="industryServicesBanner industryServicesHitechBanner industrySolutionBanner">
    ...
    <div class="floaterAnimation floaterPhoneAnimation">
        <?php $backgroundimage = get_field('background_image');
        if (!empty($backgroundimage)) : ?>
            <img src="<?php echo esc_url($backgroundimage['url']); ?>" loading="lazy" alt="<?php echo esc_attr($backgroundimage['alt']); ?>" />
        <?php endif; ?>
        ...
        <?php while (have_rows('explore_center')) : the_row(); ?>
            ...
            <div class="floaterAnimation floaterBulbAnimation">
                ...
                if (!empty($exploreiconimagetwo)) : ?>
                    <img src="<?php echo esc_url($exploreiconimagetwo['url']); ?>" loading="lazy" alt="<?php echo esc_attr($exploreiconimagetwo['alt']); ?>"  />
                <?php endif; ?>
            </div>
            <div class="wrapper">
