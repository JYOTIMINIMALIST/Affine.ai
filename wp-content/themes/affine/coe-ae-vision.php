<?php get_header(); /*Template Name: COE AE Vision*/ ?>

<section class="coeAIVisionBanner coeAEVisionBanner">
...
<img src="<?php bloginfo('template_directory'); ?>/images/ae-vision-bg-1.png" alt="" class="visionAEBg-1">
<img src="<?php bloginfo('template_directory'); ?>/images/ae-vision-bg-2.png" alt="" class="visionAEBg-2">
...
<section class="lifeSection expertsSection">
    <?php if (have_rows('experts_section', 61)) : ?>
        <?php while (have_rows('experts_section', 61)) : the_row(); ?>
