<?php get_header(); /*Template Name: COE Manufacturing*/ ?>

<section class="coeAIBanner coeManuBanner">
    <?php if( have_rows('banner_section') ): ?>
        <?php while( have_rows('banner_section') ): the_row(); ?>
            <div class="manuAnimation">
                <div id="manu-banner"></div>
                <div id="manu-banner-mob"></div>
            </div>
            <div class="AIBannerImg manuBannerImg">
                ...
                <?php endif; ?>
                <div class="manuBannerOverlay"></div>
                <img src="<?php bloginfo('template_directory'); ?>/images/manufacturing-bannerimg-1.png" alt="" class="bannerimg-1">
                <img src="<?php bloginfo('template_directory'); ?>/images/manufacturing-bannerimg-2.png" alt="" class="bannerimg-2">
            </div>
            <div class="AIBannerText">
                <div class="wrapper">
...
<section class="allSection allManuSection" id="allSection">
    <?php if( have_rows('deep_expertise') ): ?>
        <?php while( have_rows('deep_expertise') ): the_row(); ?>
            <div class="wrapper">
                        ...
                        <?php while( have_rows('card_content') ): the_row(); ?>
                            <div class="allCard">
                                <div class="allCardImg">
                                    <?php $deepexpertimage = get_sub_field('card_image');
                                        if( !empty( $deepexpertimage ) ): ?>
                                        <img src="<?php echo esc_url($deepexpertimage['url']); ?>" loading="lazy" alt="<?php echo esc_attr($deepexpertimage['alt']); ?>" />
                                    <?php endif; ?>
                                </div>
...
<section class="coeVisionSection coeManuVisionSection">
    <img src="<?php bloginfo('template_directory');?>/images/vision-screw.png" alt="" class="manuVisionBgImg-1">
    <img src="<?php bloginfo('template_directory');?>/images/vision-bolt.png" alt="" class="manuVisionBgImg-2">
    <img src="<?php bloginfo('template_directory');?>/images/vision-screw-bolt.png" alt="" class="manuVisionBgImg-3">
                                    ...
                                    <div class="coeVisionInnerSlider">
                                        <div class="coeVisionSliderDiv">
                                            <div class="coeVisionSliderImg">
                                                <?php $researchsoluimage = get_sub_field('box_image');
                                                    if( !empty( $researchsoluimage ) ): ?>
                                                    <img src="<?php echo esc_url($researchsoluimage['url']); ?>" loading="lazy" alt="<?php echo esc_attr($researchsoluimage['alt']); ?>" />
                                                <?php endif; ?>
                                            </div>
...
<section class="lifeSection expertsSection manuExpertsSection">
...
<?php if( have_rows('talk_to_expert') ): ?>
    <?php while( have_rows('talk_to_expert') ): the_row(); ?>
        <section class="talkToExpertSection talkToExpertManuSection" style="background: url(<?php echo get_sub_field('section_background_image'); ?>);background-repeat: no-repeat;background-position: bottom;">
            <div class="wrapper">
...
<section class="coeExploreSection coeManuExploreSection">
...
<?php if( have_rows('enterprises_section') ): ?>
    <?php while( have_rows('enterprises_section') ): the_row(); ?>
        <section class="enterprisesSection MANUenterprisesSection" style="background: url(<?php echo get_sub_field('background_image'); ?>);background-repeat: no-repeat;background-position: center;">
            <div class="wrapper">
