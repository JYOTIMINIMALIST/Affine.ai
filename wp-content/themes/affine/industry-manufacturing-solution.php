<?php get_header(); /*Template Name: Industry Manufacturing Solution */ ?>

<section class="industryServicesBanner industryServicesManuBanner industrySolutionBanner">
    ...
    if (!empty($backgroundimage)) : ?>
        <img src="<?php echo esc_url($backgroundimage['url']); ?>" loading="lazy" alt="<?php echo esc_attr($backgroundimage['alt']); ?>" class="solutionManuIcon"/>
    <?php endif; ?>
...
<section class="keySection" id="indutryServicesPage">
    <?php if (have_rows('key_points_section')) : ?>
        <?php while (have_rows('key_points_section')) : the_row(); ?>
            ...
            if (!empty($iconone)) : ?>
                <img src="<?php echo esc_url($iconone['url']); ?>" loading="lazy" alt="<?php echo esc_attr($iconone['alt']); ?>" class="solutionManuIcon2"/>
            <?php endif; ?>
            <div class="wrapper">
    ...
    <?php if (have_rows('explore_center')) : ?>
        <?php while (have_rows('explore_center')) : the_row(); ?>
            ...
            if (!empty($exploreiconimagetwo)) : ?>
                <img src="<?php echo esc_url($exploreiconimagetwo['url']); ?>" loading="lazy" alt="<?php echo esc_attr($exploreiconimagetwo['alt']); ?>"  class="solutionManuIcon3" />
            <?php endif; ?>
            <div class="wrapper">
