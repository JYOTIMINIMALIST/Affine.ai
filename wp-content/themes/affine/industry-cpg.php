<?php get_header(); /*Template Name: Industry CPG*/ ?>

<section class="cpgBanner">
    <div class="indcpgAnimation" style="z-index: 3;">
        <div id="industrycpg-banner"></div>
        <div id="industrycpg-banner-mob"></div>
    </div>
    <div class="cpgBannerSlider indcpgBannerImg">
...
<section class="cpgServices" id="cpgServices">
    <div class="cpgServicesOverlay">
        <div class="cpgOverlayCard">
            <img src="<?php bloginfo('template_directory'); ?>/images/cpg-overlay.png" alt="">
        </div>
        <div class="cpgOverlayCard">
            <img src="<?php bloginfo('template_directory'); ?>/images/cpg-overlay.png" alt="">
        </div>
...
<section class="talkToExpertSection talkToExpertCPGSection" id="talkToExpertCPGSection">
    <img src="<?php bloginfo('template_directory'); ?>/images/cpg-talk-bg.png" alt="" class="cpgTalkBg">
    <img src="<?php bloginfo('template_directory'); ?>/images/talk-cpg-1.png" alt="" class="cpgTalk1">
    <img src="<?php bloginfo('template_directory'); ?>/images/talk-cpg-2.png" alt="" class="cpgTalk2">
    <?php if( have_rows('talk_to_expert') ): ?>
        <?php while( have_rows('talk_to_expert') ): the_row(); ?>
            <div class="wrapper">
                <div class="ExpertCPGHolder">
                    <div class="expertCPGImg">
                        <img src="<?php bloginfo('template_directory'); ?>/images/cpg-scan.png" alt=""  class="cpgScan">
...
$(window).on('resize scroll', function() {
    if ($('#cpgServices').isInViewport()) {
        $('.cpgServicesOverlay').addClass('active');
        setTimeout(() => {
            $('.cpgServicesOverlay').fadeOut();
        }, 2000);
    }
    if ($('#talkToExpertCPGSection').isInViewport()) {
        $('.expertCPGImg').addClass('active');
        setTimeout(() => {
            $('.cpgScan').fadeOut();
        }, 1700);
        setTimeout(() => {
            $('.expertCPGImg').addClass('disable');
            $('.cpgPhone').fadeIn();
        }, 1800);
    }
});
...
if ($("#industrycpg-banner").length) {
  var robotAnim = lottie.loadAnimation({
    container: document.getElementById('industrycpg-banner'), // Required
    path: site_url + '/wp-content/themes/affine/js/json/industrycpg-banner.json', // Required
    renderer: 'svg', // Required
    loop: false, // Optional
    autoplay: true, // Optional
    name: "industrycpg-banner", // Name for future reference. Optional.
  });
}
if ($("#industrycpg-banner-mob").length) {
  var robotAnim = lottie.loadAnimation({
    container: document.getElementById('industrycpg-banner-mob'), // Required
    path: site_url + '/wp-content/themes/affine/js/json/industrycpg-banner-mob.json', // Required
    renderer: 'svg', // Required
    loop: false, // Optional
    autoplay: true, // Optional
    name: "industrycpg-banner-mob", // Name for future reference. Optional.
  });
}
</script>