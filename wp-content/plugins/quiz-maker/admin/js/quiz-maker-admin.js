(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ( checkCountdownIsExists.length > 0 ) {
            ...
            var countdownEndTime = "SEP 1, 2021 23:59:59",
            ...
            x = setInterval(function() {
                ...
                document.getElementById("ays-quiz-countdown-days").innerText = Math.floor(distance / (day)),
                document.getElementById("ays-quiz-countdown-hours").innerText = Math.floor((distance % (day)) / (hour)),
                document.getElementById("ays-quiz-countdown-minutes").innerText = Math.floor((distance % (hour)) / (minute)),
                document.getElementById("ays-quiz-countdown-seconds").innerText = Math.floor((distance % (minute)) / second);
