<div id="ays-quiz-subscribe-email-page-main">
    ...
    <div class="ays-quiz-subscribe-email-page-info-box">
        <span>Want a free addon for your Quiz Maker plugin to make your experience more advanced and better?<br>
        Subscribe with a valid email address to get the <strong>Export Results</strong> addon as a <strong>GIFT</strong>.<br>
